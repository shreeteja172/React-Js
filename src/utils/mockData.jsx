const restaurantsData = [
  {
    ...
    cuisines: "Indian Paneer Biryani",
  ...
  {
    id: 11,
    title: "Egg Biryani Express",
    cuisines: "Egg Biryani Special",
